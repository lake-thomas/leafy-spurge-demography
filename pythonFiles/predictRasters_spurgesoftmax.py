...
outpath = r'/panfs/roc/groups/7/moeller/shared/leafy-spurge-demography/datasets_oct22/raster_predictions_2019_spurgesoftmax'
...
with rasterio.open(fp=outpath + "/prediction_softmax_" + fileout_string[-1], #outputpath_name
