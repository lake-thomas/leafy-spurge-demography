...
import ee
service_account = 'gee-spurge-dl-proj@ee-rbriscoe.iam.gserviceaccount.com'
credentials = ee.ServiceAccountCredentials(service_account, '/home/moeller/shared/leafy-spurge-demography/jsonKeys/ee-rbriscoe-647d488a014c.json')
...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = '/home/moeller/shared/leafy-spurge-demography/jsonKeys/ee-rbriscoe-647d488a014c.json'
...
SERVICE_ACCOUNT_FILE = '/home/moeller/shared/leafy-spurge-demography/jsonKeys/ee-rbriscoe-647d488a014c.json'
...
# Our study area is rather large, so we break it up into several areas wiht a sliding window
# In each of htese areas, we will select points to extract Landsat imagery & NLCD class values
...
OUTPUT_BUCKET = 'spurge-demography-geotiffs-1986'
